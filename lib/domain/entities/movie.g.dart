...
Id _movieGetId(Movie object) {
  return object.issarId ?? Isar.autoIncrement;
}
...
extension MovieQueryWhereSort on QueryBuilder<Movie, Movie, QWhere> {
  QueryBuilder<Movie, Movie, QAfterWhere> anyIssarId() {
...
extension MovieQueryWhere on QueryBuilder<Movie, Movie, QWhereClause> {
  QueryBuilder<Movie, Movie, QAfterWhereClause> issarIdEqualTo(Id issarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterWhereClause> issarIdNotEqualTo(Id issarId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
              IdWhereClause.lessThan(upper: issarId, includeUpper: false),
            )
            .addWhereClause(
              IdWhereClause.greaterThan(lower: issarId, includeLower: false),
            );
      } else {
        return query
            .addWhereClause(
  ...
  QueryBuilder<Movie, Movie, QAfterWhereClause> issarIdGreaterThan(Id issarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.greaterThan(lower: issarId, includeLower: include),
      );
    });
  }

  QueryBuilder<Movie, Movie, QAfterWhereClause> issarIdLessThan(Id issarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: issarId, includeUpper: include),
      );
    });
  }

  QueryBuilder<Movie, Movie, QAfterWhereClause> issarIdBetween(
    Id lowerIssarId,
    Id upperIssarId, {
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> issarIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> issarIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> issarIdEqualTo(Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'issarId',
        value: value,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> issarIdGreaterThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> issarIdLessThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> issarIdBetween(
    Id? lower,
    Id? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIssarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'issarId', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIssarIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'issarId', Sort.desc);
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  QueryBuilder<Movie, int, QQueryOperations> issarIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'issarId');
    });
  }
